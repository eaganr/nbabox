function playbyplay() {  
  ...
  self.qtr=function(q) {
    ...
    else return self.qtr.val ? self.qtr.val : 1;
  }
  ...
  self.w=function(w) {
    ...
    return self.w.val ? self.w.val : $(window).width()*3.55;
  }
  ...
  self.h=function(h) {
    ...
    return self.h.val ? self.h.val : 1800;
  }
  ...
  updatemenu=function(seconds) {
    ...
    if(x > self.margins().left && x <= self.w() - self.margins().right) {
      ...
      if(x > self.w()/4*(self.qtr())-self.margins().right-menuwidth) x = self.w()/4*self.qtr()-self.margins().right-menuwidth;
  ...
  self.draw=function() {
    ...
    self.qtr(self.data()[self.data().length-1].period);
    ...
    for(var i=0;i<ticks.length;i++) {
      ...
      self.vis.append("svg:text")
        ...
        .attr("transform","translate("+self.xScale(ticks[i]+310)+",59)")
    ...
    var moving = self.vis.append("svg:g")
      .attr("id","moving-svg")
    ...
    moving.append("svg:g")
      ...
      .call(yAxis)
      .selectAll("text").attr("font-size", "30px");
    ...
    self.vis.selectAll("circle")
      ...
      .on("mouseout", function() { d3.select(this).attr("r", rad); rollover = false;});
    ...
    var menu = self.vis.append('svg:g')
      ...
      .style("z-index",50);
    menu.html('<defs><clipPath id="clipPath"><rect x="0" y="0" width="398" height="100" /></clipPath></defs>');
    ...
    //legend
    var legwidth = 70;
    moving = moving.append("svg:g").attr("transform","translate(160,0)");
    moving.append("svg:rect")
      .attr("class","legend-rect")
      .attr("fill","orange")
      .attr("transform","translate(33,"+(self.h()+10)+")")
      .attr("opacity", statson["Points"] ? 1:0.3)
      .attr("width",legwidth)
      .attr("height",legwidth)
      .attr("text","Points");
    moving.append("svg:text")
      .attr("class","legend-text")
      .attr("transform","translate(108,"+(self.h()+16)+")")
      .attr("dy", "1em")
      .style("font-size", "35px")
      .text("Points");
    ...
    moving.append("svg:rect")
      .attr("class","legend-rect")
      .attr("fill","#996633")
      .attr("transform","translate(200,"+(self.h()+10)+")")
    ...
    moving.append("svg:text")
      .attr("class","legend-text")
      .attr("transform","translate(280,"+(self.h()+16)+")")
      .attr("dy", "1em")
      .style("font-size", "35px")
      .text("Misses");
    ...
    moving.append("svg:rect")
      .attr("class","legend-rect")
      .attr("fill","green")
      .attr("transform","translate(380,"+(self.h()+10)+")")
    ...
    moving.append("svg:rect")
      ...
      .attr("transform","translate(560,"+(self.h()+10)+")")
      .attr("width",legwidth)
      .attr("height",legwidth)
      .attr("text","Rebounds");
    moving.append("svg:text")
      .attr("class","legend-text")
      .attr("transform","translate(635,"+(self.h()+16)+")")
      .attr("dy", "1em")
      .style("font-size", "35px")
      .text("Rebounds");
    ...
    moving.append("svg:rect")
      ...
      .attr("transform","translate(33,"+(self.h()+90)+")")
      .attr("width",legwidth)
      .attr("height",legwidth)
      .attr("text","Steals");
    moving.append("svg:text")
      .attr("class","legend-text")
      .attr("transform","translate(108,"+(self.h()+96)+")")
      .attr("dy", "1em")
      .style("font-size", "35px")
      .text("Steals");
    ...
    moving.append("svg:rect")
      ...
      .attr("transform","translate(200,"+(self.h()+90)+")")
      .attr("width",legwidth)
      .attr("height",legwidth)
      .attr("text","TOs");
    moving.append("svg:text")
      .attr("class","legend-text")
      .attr("transform","translate(275,"+(self.h()+96)+")")
      .attr("dy", "1em")
      .style("font-size", "35px")
      .text("TOs");
    ...
    moving.append("svg:rect")
      ...
      .attr("transform","translate(380,"+(self.h()+90)+")")
      .attr("width",legwidth)
      .attr("height",legwidth)
      .attr("text","Blocks");
    moving.append("svg:text")
      .attr("class","legend-text")
      .attr("transform","translate(455,"+(self.h()+96)+")")
      .attr("dy", "1em")
      .style("font-size", "35px")
      .text("Blocks");
    ...
    moving.append("svg:rect")
      ...
      .attr("transform","translate(560,"+(self.h()+90)+")")
      .attr("width",legwidth)
      .attr("height",legwidth)
      .attr("text","Fouls");
    moving.append("svg:text")
      .attr("class","legend-text")
      .attr("transform","translate(635,"+(self.h()+96)+")")
      .attr("dy", "1em")
      .style("font-size", "35px")
      .text("Fouls");
