function schedule() {	
  ...
  var firstdraw = true;
    ...
    gamesdiv.className = "schedule-games";
    maindiv.appendChild(gamesdiv);
    maindiv = gamesdiv;
      ...
      if(self.games[i]["period"].indexOf(" ET") > -1) self.games[i]["period"] = self.games[i]["period"].replace(" ET","<br />ET");
      period.innerHTML=self.games[i]["period"];
      if(self.games[i]["period"].indexOf("<br />ET") === -1) {
